...
ModesRegistry.registerLanguage({
    ...
    aliases: [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$nls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["localize"]('plainText.alias', "Plain Text"),
        'text'
    ],
    mimetypes: [
...
function _tokenizeToString(text, languageIdCodec, tokenizationSupport) {
    ...
    for(let i = 0, len = lines.length; i < len; i++){
        ...
        for(let j = 0, lenJ = viewLineTokens.getCount(); j < lenJ; j++){
            ...
            result += `<span class="${type}">${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$strings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escape"](line.substring(startOffset, endIndex))}</span>`;
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_editor_common_languages_64002e67._.js.map