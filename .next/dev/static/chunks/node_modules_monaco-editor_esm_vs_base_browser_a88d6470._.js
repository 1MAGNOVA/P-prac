...
function hookDomPurifyHrefAndSrcSanitizer(allowedProtocols, allowDataImages = false) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addHook"]('afterSanitizeAttributes', (node)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDisposable"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeHook"]('afterSanitizeAttributes');
    });
}
    ...
    if (monacoEnvironment) {
        ...
        if (typeof monacoEnvironment.getWorkerUrl === 'function') {
            ...
            return new Worker(ttPolicy ? ttPolicy.createScriptURL(workerUrl) : workerUrl, {
                name: label,
                type: ("TURBOPACK compile-time truthy", 1) ? 'module' : "TURBOPACK unreachable"
            });
        }
    }
    // ESM-comment-begin
...
function getWorkerBootstrapUrl(label, workerScriptUrl, workerBaseUrl) {
    ...
    const blob = new Blob([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["coalesce"])([
            ...
            ("TURBOPACK compile-time truthy", 1) ? `await import(ttPolicy?.createScriptURL('${workerScriptUrl}') ?? '${workerScriptUrl}');` : "TURBOPACK unreachable",
            ("TURBOPACK compile-time truthy", 1) ? `globalThis.postMessage({ type: 'vscode-worker-ready' });` : "TURBOPACK unreachable",
            `/*${label}*/`
        ]).join('')
    ], {
...
class WorkerDescriptor {
    constructor(amdModuleId, label){
        ...
        this.label = label;
        this.esmModuleLocation = ("TURBOPACK compile-time truthy", 1) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileAccess"].asBrowserUri(`${amdModuleId}.esm.js`) : "TURBOPACK unreachable";
    }
}
...
class Gesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Disposable"] {
    ...
    onTouchEnd(targetWindow, e) {
        ...
        for(let i = 0, len = e.changedTouches.length; i < len; i++){
            ...
            if (holdTime < Gesture.HOLD_DELAY && Math.abs(data.initialPageX - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageX)) < 30 && Math.abs(data.initialPageY - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageY)) < 30) {
                const evt = this.newGestureEvent(EventType.Tap, data.initialTarget);
                evt.pageX = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageX);
                evt.pageY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageY);
                this.dispatchEvent(evt);
            } else if (holdTime >= Gesture.HOLD_DELAY && Math.abs(data.initialPageX - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageX)) < 30 && Math.abs(data.initialPageY - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageY)) < 30) {
                const evt = this.newGestureEvent(EventType.Contextmenu, data.initialTarget);
                evt.pageX = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageX);
                evt.pageY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageY);
                this.dispatchEvent(evt);
            } else if (activeTouchCount === 1) {
                const finalX = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageX);
                const finalY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageY);
                const deltaT = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingTimestamps) - data.rollingTimestamps[0];
    ...
    onTouchMove(e) {
        ...
        for(let i = 0, len = e.changedTouches.length; i < len; i++){
            ...
            evt.translationX = touch.pageX - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageX);
            evt.translationY = touch.pageY - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$arrays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tail"](data.rollingPageY);
            evt.pageX = touch.pageX;
            evt.pageY = touch.pageY;
            this.dispatchEvent(evt);
...
function renderMarkdown(markdown, options = {}, markedOptions = {}) {
    ...
    if (options.actionHandler) {
        ...
        options.actionHandler.disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Event"].any(onClick.event, onAuxClick.event)((e)=>{
            const mouseEvent = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$mouseEvent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardMouseEvent"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWindow"](element), e);
            if (!mouseEvent.leftButton && !mouseEvent.middleButton) {
                return;
            }
            _activateLink(mouseEvent);
        }));
        options.actionHandler.disposables.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDisposableListener"](element, 'keydown', (e)=>{
    ...
    if (options.fillInIncompleteTokens) {
        ...
        const tokens = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lexer"](value, opts);
        const newTokens = fillInIncompleteTokens(tokens);
        renderedMarkdown = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parser"](newTokens, opts);
    } else {
        renderedMarkdown = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parse"](value, {
            ...markedOptions,
            async: false
        });
    }
        ...
        if (src) {
            ...
            if (options.remoteImageIsAllowed) {
                ...
                if (uri.scheme !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].file && uri.scheme !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$network$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Schemas"].data && !options.remoteImageIsAllowed(uri)) {
                    img.replaceWith(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$"]('', undefined, img.outerHTML));
                }
            }
        }
    });
...
function sanitizeRenderedMarkdown(options, renderedMarkdown) {
    ...
    store.add(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dom$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hookDomPurifyHrefAndSrcSanitizer"](allowedSchemes));
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sanitize"](renderedMarkdown, {
            ...config,
            RETURN_TRUSTED_TYPE: true
        });
    } finally{
...
function completeWithString(tokens, closingString) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$marked$2f$marked$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lexer"](mergedRawText + closingString)[0];
}
...
function addDompurifyHook(hook, cb) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addHook"](hook, cb);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$common$2f$lifecycle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDisposable"])(()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$monaco$2d$editor$2f$esm$2f$vs$2f$base$2f$browser$2f$dompurify$2f$dompurify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeHook"](hook));
}
}),
...
//# sourceMappingURL=node_modules_monaco-editor_esm_vs_base_browser_a88d6470._.js.map